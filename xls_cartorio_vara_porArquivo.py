...
# Pasta de destino
pasta_destino = r"C:\Users\dyego\OneDrive\Área de Trabalho\raspagem-cartorio"
...
for estado in estados:
    ...
    try:
        ...
        for url_municipio in links_municipios:
            ...
            dados_estado.extend(dados_municipio)
            time.sleep(1)

        # Salvar planilha por estado
        caminho_arquivo = os.path.join(pasta_destino, f"cartorios_{estado}.xlsx")
